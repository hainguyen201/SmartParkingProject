...
<div style="height: 100vh">
  <el-row style="height: 50px;background-color: #7d7df9; border-radius: 5px 5px 5px 0px; width: 100%;">
    <el-col :span="6" style="color: white; font-weight: bold; margin-left: 4px; display:flex; align-items: center; height:100%"><span>Smart Parking System</span></el-col>
