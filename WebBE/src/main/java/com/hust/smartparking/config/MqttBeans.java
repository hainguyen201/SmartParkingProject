package com.hust.smartparking.config;
...
public class MqttBeans {
    ...
    private String camera_topic="channel_hust/camera";
    @Bean
    public MqttPahoClientFactory mqttClientFactory() {
        DefaultMqttPahoClientFactory factory = new DefaultMqttPahoClientFactory();
        MqttConnectOptions options = new MqttConnectOptions();
        options.setServerURIs(new String[] { Constants.broker });
    ...
    public MessageProducer inbound() {
        MqttPahoMessageDrivenChannelAdapter adapter = new MqttPahoMessageDrivenChannelAdapter("serverIn",
                mqttClientFactory(),
                Constants.camera_topic,
                Constants.topicSensorSonicParking,
                Constants.topicSensorSonicGate,
                Constants.topicSensorSonicGateAfter);
    ...
    public MessageHandler handler() {
        return new MessageHandler() {
            ...
            public void handleMessage(Message<?> message) throws MessagingException {
                ...
                if(topic.equals(Constants.topicSensorSonicParking)){
